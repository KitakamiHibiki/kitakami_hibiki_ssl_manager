...
type Certificate struct {
	...
	Domain        string         `gorm:"uniqueIndex:idx_cert_domain_active,where:deleted_at IS NULL;not null" json:"domain"`
...
func InitDB(dsn string) (*DB, error) {
	...
	if err := db.AutoMigrate(&Certificate{}, &User{}, &SystemConfig{}, &DeployNode{}); err != nil {
		return nil, err
	}
	return &DB{db}, nil
}
